...
class GPUDFSChildrenFirst(GPUTransitionSystem):
    """
    ...
    def initial_state(self, sentences : List[AMSentence], decoder_state : Any, device: Optional[int] = None) -> GPUDFSChildrenFirstState:
    ...
    def step(self, state: GPUDFSChildrenFirstState, decision_batch: DecisionBatch) -> None:
        """
