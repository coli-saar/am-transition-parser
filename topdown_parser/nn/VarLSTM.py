...
def VarLSTMCellF(input, hidden, w_ih, w_hh, b_ih=None, b_hh=None, noise_in=None, noise_hidden=None):
...
class MaLSTMCell(DecoderCell):
    ...
    def __init__(self, input_dim: int, hidden_dim: int, input_dropout : float = 0.0, recurrent_dropout : float = 0.0):
        ...
        self.lstm_cell = VarLSTMCell(input_dim, hidden_dim, True, input_dropout, recurrent_dropout)
